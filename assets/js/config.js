/* =========================================================
   Millán Academy — configuración de la notificación por email
   =========================================================

   El check-in de los profes (foto al llegar a la cancha) se manda por
   email a Millán usando Web3Forms (gratis, sin backend propio).

   Cómo activarlo (5 minutos, lo hace Millán una sola vez):
